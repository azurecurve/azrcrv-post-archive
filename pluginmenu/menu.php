 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_pa')){
	function azrcrv_create_plugin_menu_pa(){
		azrcrv_create_plugin_menu_table_pa();
		azrcrv_populate_plugin_menu_table_pa();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_pa')){
	function azrcrv_populate_plugin_menu_table_pa(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_pa')){
	function azrcrv_create_plugin_menu_table_pa(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
